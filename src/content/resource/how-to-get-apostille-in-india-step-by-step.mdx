...
Authentication depends on document **classification** (full DIY guide here): <Anchor href="/resources/document-authentication-india-coc-hrd-vs-sdm-home-state-attestation/">Document Authentication in India (DIY): Personal, Educational & Commercial</Anchor>, as below.
